...
// pubusb 
const pubSubName = process.env.PUBSUB_NAME || "pipeline-tweets";
const topicName = process.env.TOPIC_NAME || "processed";
const pubEndpoint = `http://localhost:${daprPort}/v1.0/publish/${pubSubName}/${topicName}`;
